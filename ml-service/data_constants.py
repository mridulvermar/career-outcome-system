...
EXTENDED_SKILL_MAPPING = {
    'AI Engineer': ['Artificial Intelligence', 'Machine Learning', 'Deep Learning', 'TensorFlow', 'PyTorch', 'Neural Networks', 'NLP', 'Computer Vision', 'Generative AI', 'Transformers', 'Python', 'MLOps', 'Docker', 'Kubernetes', 'AWS', 'Azure', 'BERT', 'GPT', 'Model Deployment', 'Data Preprocessing', 'Feature Engineering', 'Keras', 'Scikit-learn', 'Hugging Face', 'LLMs', 'Mojo'],
    'ML Engineer': ['Machine Learning', 'Model Training', 'Python', 'Scikit-learn', 'TensorFlow', 'PyTorch', 'Data Modeling', 'Feature Engineering', 'MLOps', 'Pandas', 'NumPy', 'AWS', 'SQL', 'Mathematics', 'Statistics', 'XGBoost', 'Random Forest', 'Regression', 'Classification', 'Model Evaluation', 'Data Preprocessing', 'Keras', 'Hugging Face', 'LLMs', 'Mojo'],
    'Data Scientist': ['Data Science', 'Statistics', 'Machine Learning', 'Python', 'SQL', 'Data Visualization', 'Pandas', 'NumPy', 'R', 'Tableau', 'Power BI', 'Big Data', 'Matplotlib', 'Seaborn', 'Jupyter', 'Data Analysis', 'Predictive Modeling', 'A/B Testing', 'Hypothesis Testing', 'Data Mining', 'Statistical Analysis', 'TensorFlow', 'PyTorch', 'Scikit-learn', 'Julia'],
    'Data Engineer': ['Data Engineering', 'ETL', 'SQL', 'Python', 'Spark', 'Apache Spark', 'Big Data', 'Data Warehousing', 'Data Pipeline', 'Airflow', 'Kafka', 'Hadoop', 'Database Design', 'AWS', 'Azure', 'GCP', 'PostgreSQL', 'MongoDB', 'Redis', 'Scala', 'Java', 'Snowflake', 'Databricks', 'NoSQL', 'Cassandra', 'Elasticsearch'],
    'Software Engineer': ['Software Engineering', 'System Design', 'Data Structures', 'Algorithms', 'Java', 'C++', 'Python', 'Object-Oriented Programming', 'Design Patterns', 'Problem Solving', 'Git', 'SQL', 'DSA', 'Testing', 'Debugging', 'Code Review', 'Agile', 'REST API', 'Microservices', 'Linux', 'Version Control', 'C', 'C#', 'Go', 'Rust', 'Scala', 'Dart', 'Lua', 'Haskell', 'Objective-C', 'Assembly', 'Perl'],
    'Full Stack Developer': ['Full Stack', 'React', 'Node.js', 'JavaScript', 'HTML', 'CSS', 'MongoDB', 'SQL', 'REST API', 'Express.js', 'Express', 'Git', 'TypeScript', 'PostgreSQL', 'MySQL', 'Redux', 'Next.js', 'Vue.js', 'Vue', 'Angular', 'Responsive Design', 'Web Development', 'Frontend', 'Backend', 'Svelte', 'TRPC', 'Zustand', 'GraphQL', 'NestJS', 'Django', 'Flask', 'FastAPI', 'Spring Boot', 'ASP.NET', 'Laravel', 'Rails', 'Material UI', 'Tailwind CSS', 'Bootstrap', 'WebSockets', 'Prisma', 'Sequelize', 'Supabase', 'Firebase', 'SQLite', 'MariaDB', 'Mongoose', 'Sass', 'Less'],
    'Frontend Engineer': ['Frontend', 'React', 'JavaScript', 'HTML', 'CSS', 'UI/UX', 'Responsive Design', 'TypeScript', 'Angular', 'Vue.js', 'Redux', 'Webpack', 'SASS', 'LESS', 'Tailwind CSS', 'Bootstrap', 'jQuery', 'Web Performance', 'Accessibility', 'Cross-browser Compatibility', 'ES6', 'Next.js', 'Zustand', 'Axios', 'Material UI', 'MUI', 'Svelte'],
    'Backend Engineer': ['Backend', 'API Design', 'Java', 'Python', 'Node.js', 'SQL', 'NoSQL', 'Microservices', 'System Design', 'Database Design', 'Redis', 'Docker', 'PostgreSQL', 'MongoDB', 'REST API', 'GraphQL', 'Spring Boot', 'Django', 'Flask', 'Express.js', 'Kafka', 'RabbitMQ', 'Go', 'Caching', 'NestJS', 'FastAPI', 'ASP.NET', 'Laravel', 'Rails', 'C#', 'PHP', 'Ruby', 'MySQL', 'Prisma', 'Sequelize', 'Supabase', 'Firebase', 'SQLite', 'MariaDB', 'Elasticsearch'],
    'DevOps Engineer': ['DevOps', 'CI/CD', 'Docker', 'Kubernetes', 'Jenkins', 'Terraform', 'Linux', 'AWS', 'Azure', 'GCP', 'Ansible', 'Git', 'Bash', 'Python', 'Monitoring', 'Prometheus', 'Grafana', 'Infrastructure as Code', 'Shell Scripting', 'Automation', 'Cloud Computing', 'Networking', 'Unix', 'GitHub', 'GitLab', 'Bitbucket', 'Nginx', 'Apache', 'Heroku', 'Vercel', 'Netlify', 'CircleCI'],
    'Cloud Architect': ['Cloud Architecture', 'AWS', 'Azure', 'GCP', 'Google Cloud', 'System Design', 'Microservices', 'Networking', 'Security', 'Kubernetes', 'Terraform', 'Cloud Computing', 'Infrastructure as Code', 'Serverless', 'Lambda', 'EC2', 'S3', 'VPC', 'Load Balancing', 'Auto Scaling', 'Cloud Migration', 'Cost Optimization', 'DevOps', 'Docker', 'DynamoDB'],
    ...
    'Product Manager': ['Product Management', 'Product Strategy', 'User Research', 'Roadmapping', 'Agile', 'Scrum', 'Stakeholder Management', 'Data Analysis', 'Communication', 'Leadership', 'Product Development', 'Market Research', 'User Stories', 'A/B Testing', 'Analytics', 'Product Lifecycle', 'Prioritization', 'SQL', 'Jira', 'Product Vision', 'Trello', 'Slack', 'Project Management'],
    ...
    'Data Analyst': ['Data Analysis', 'SQL', 'Excel', 'Tableau', 'Power BI', 'Statistics', 'Data Visualization', 'Python', 'Reporting', 'Pandas', 'NumPy', 'Dashboard', 'Google Analytics', 'R', 'Data Mining', 'Business Intelligence', 'ETL', 'Data Cleaning', 'Analytics', 'Matplotlib', 'Seaborn'],
    ...
    'Project Manager': ['Project Management', 'Agile', 'Scrum', 'Risk Management', 'Stakeholder Management', 'Leadership', 'Communication', 'Planning', 'Budgeting', 'Resource Management', 'JIRA', 'MS Project', 'PMP', 'Kanban', 'Team Management', 'Problem Solving', 'Documentation', 'Reporting', 'Timeline Management', 'Trello', 'Slack'],
    'Mobile Developer': ['React Native', 'Flutter', 'Android', 'iOS', 'Ionic', 'Xamarin', 'Kotlin Multiplatform', 'Java', 'Kotlin', 'Swift', 'Objective-C', 'Dart', 'Mobile Development', 'React', 'JavaScript', 'Responsive Design', 'API Integration', 'UI/UX']
}
...
SKILL_SYNONYMS = {
    ...
    'asp.net': ['asp.net', 'aspnet', 'asp .net', '.net'],
...
DEGREE_MAP = {
    'Computer Science': ['Software Engineer', 'Full Stack Developer', 'Backend Engineer', 'Frontend Engineer', 'DevOps Engineer', 'AI Engineer', 'ML Engineer', 'Cloud Architect', 'Cybersecurity Analyst', 'Blockchain Developer', 'Data Scientist', 'Data Engineer', 'Mobile Developer'],
    ...
    'Business': ['Product Manager', 'Business Analyst', 'Consultant', 'Marketing Manager', 'Project Manager', 'Data Analyst'],
    'Mathematics': ['Data Scientist', 'Data Analyst', 'ML Engineer', 'Research Scientist', 'AI Engineer', 'BI Analyst'],
